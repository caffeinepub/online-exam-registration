...
export class Backend implements backendInterface {
    ...
    async getExamsByCategory(arg0: string): Promise<Array<Exam>> {
        if (this.processError) {
            try {
                const result = await this.actor.getExamsByCategory(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getMyRegistrations(): Promise<Array<ExamRegistration>> {
        if (this.processError) {
            try {
    ...
    async login(arg0: string, arg1: string): Promise<Profile> {
        if (this.processError) {
            try {
    ...
    async registerForExam(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.registerForExam(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async unregisterFromExam(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.unregisterFromExam(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
